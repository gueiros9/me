...
class JanelaInicial:
    def __init__(self, root):
        ...
        btn_stats = ttk.Button(frame_botoes, text="Visualizar Estatisticas", command=lambda: self.abrir_visualizar_grafico(root))
        ...
        btn_stats.grid(row=2, column=0, pady=10)
        btn_alterar_remover.grid(row=3, column=0, pady=10)
    ...
    def abrir_visualizar_grafico(self, root):
        open_window("Despesas/statsDespesas", root)
